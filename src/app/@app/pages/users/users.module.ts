...
import { UserPermissionsComponent } from './user-edit/user-permissions/user-permissions.component';
...
@NgModule({
  ...
  providers: [],
  exports: [],
  declarations: [UsersComponent, UserEditComponent, UserProfileComponent, AccountComponent,UserPermissionsComponent, IdCardDialogComponent]
})
