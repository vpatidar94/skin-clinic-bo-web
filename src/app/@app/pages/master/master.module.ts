...
@NgModule({
  ...
  providers: [],
  exports: [],
  declarations: [MasterComponent, ServicesComponent, ServiceTypeComponent, ProductsComponent, AddServiceTypeComponent, AddServiceComponent, AddDepartmentComponent, AddUserTypeComponent ]
})
